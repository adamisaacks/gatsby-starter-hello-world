...
const navigation = [
  { name: "Home", href: "#", current: false, place: 0 },
  { name: "Engineer", href: "#", current: false, place: 1 },
    ...
    <div className="text-gray-100">
      ...
      <div className="fixed z-20 w-screen">
        ...
        >
          {({ open }) => (
            <>
              <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 backdrop-blur-md">
                <div className="relative flex items-center justify-between h-16">
                  <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                    {/* Mobile menu button*/}
                    <Disclosure.Button className="inline-flex items-center justify-center p-2 rounded-md text-gray-100 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
                          ...
                          <a
                            ...
                            className={classNames(
                              item.current
                                ...
                                : "text-gray-100 hover:font-bold hover:text-white",
